...
const UnemploymentRatePredictorSection = () => {
  ...
  const extractCountries = (parsedData) => {
    const uniqueCountries = [
      ...new Set(parsedData.map((item) => item.country)),
    ];
  ...
  const placeholderData = Array.from(
    { length: parseInt(filters.year || endYear) - startYear + 1 },
    (_, index) => {
              ...
              <Form className={styles.inputContainer}>
                <div>
                  <CustomSelect
                    ...
                    value={
                      values.age
                        ? { value: values.age, label: values.age.toString() }
                        : null
                    }
                ...
                <div>
                  <CustomSelect
                    ...
                    value={
                      values.sex
                        ? { value: values.sex, label: values.sex }
                        : null
                    }
                ...
                <div>
                  <CustomSelect
                    ...
                    value={
                      values.year
                        ? { value: values.year, label: values.year.toString() }
                        : null
                    }
                    ...
                    if (active && payload && payload.length) {
                      ...
                      return (
                        <div className={styles.customTooltip}>
                          <p className={styles.textYear}>{`Year: ${year}`}</p>
                          <p
                            className={styles.unemploymentRate}
                    ...
                    dot={(dotProps) => {
                      ...
                      return (
                        <circle
                          ...
                          stroke={
                            payload.year >= "2024" ? "#FF0000" : "#627254"
                          }
                        />
                      );
                    }}
            ...
            {state !== null && year !== null && (
              <>
                <p className={styles.secondText}>
                  Compared to the year 2023, a{" "}
                  <u>{state.toString().toLowerCase()} </u>
